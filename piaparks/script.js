...
const map = new mapboxgl.Map({
  ...
  zoom: 9.5,
    ...
    function renderListings(features) {
      ...
      // Clear any existing listings
        ...
        if (features.length) {
            ...
            map.setFilter('piaparks-8uxc07', ['has', 'PlaceName']);
        }
    }
    ...
    map.on('load', () => {
        ...
        map.on('moveend', () => {
            const features = map.queryRenderedFeatures({ layers: ['piaparks-8uxc07'] });
            ...
            if (features) {
                ...
                // Store the current features in sn `Parks` variable to
                // later use for filtering on `keyup`.
                Parks = uniqueFeatures;
            }
        });

        map.on('mousemove', 'piaparks-8uxc07', (e) => {
        ...
        map.on('mouseleave', 'piaparks-8uxc07', () => {
...
// user geolocation position generation into terminal
